...
- [ ] T004 Create shared game domain types and constants in src/game/core/types.ts
...
- [ ] T007 [US1] Add initialization unit coverage in tests/unit/core/state.test.ts and implement the new-game state factory in src/game/core/state.ts
...
- [ ] T009 [US2] Add move-validation unit coverage for valid moves, occupied cells, out-of-range indexes, and non-integer inputs in tests/unit/core/rules.test.ts and implement single-move validation and human move application in src/game/core/rules.ts
